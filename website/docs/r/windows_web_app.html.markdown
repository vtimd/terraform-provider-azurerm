...
* `name` - The name given to this Connection String.

---

A `cors` block supports the following:

* `allowed_origins` - (Required) Specifies a list of of origins that should be allowed to make cross-origin calls.
